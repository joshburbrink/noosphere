...
// Idempotent: only seeds region_* keys that don't already exist. Lets
// existing instances pick up region defaults without clobbering anything.
function _seed_region_defaults($db) {
    $defaults = [
        'active_region'       => 'world',
        'region_label'        => 'Generic / no region',
        'region_country'      => '',
        'region_state'        => '',
        'region_counties'     => '',
        'region_climate_zone' => '',
...
function _presets() {
    ...
    return [
        'emergency' => [
            ...
            'show_canvas'         => '0',
            'show_alpr'           => '0',
            'radio_monitor_freq'  => '146.520M',
            'runners_label'        => 'Runner Board',
            'registry_allow_self_register' => '1',
            'require_registration'        => '0',
            'incident_type_set'           => 'disaster',
            'registry_track_children'     => '1',
            'registry_show_location'      => '1',
            'registry_show_status'        => '1',
        ],
        // Camping / outdoor trip - friendly, non-emergency. Opt-in preset; the
        // project default remains 'emergency'. Hides location/status/child
        // prompts, uses camping-themed map pins, library + games on.
        'camping' => [
            'instance_name'             => 'Campsite Hub',
            'instance_tagline'          => 'Maps, library, chat & games',
            'readonly'                  => '0',
            'homepage_alert'            => '',
            'show_registry'             => '1',
            'registry_label'            => 'Camp Check-In',
            'registry_description'      => '',
            'registry_checkin'          => '1',
            'registry_statuses'         => 'Here, On the way, Headed out',
            'registry_fields'           => _rf([]),
            'registry_found_person'     => '0',
            'registry_location_required'=> '0',
            'registry_track_children'   => '0',
            'registry_show_location'    => '0',
            'registry_show_status'      => '0',
            'registry_shelter'          => '0',
            'shelter_name'         => '',
            'shelter_capacity'     => '0',
            'show_chat'            => '1',
            ...
            'show_calendar'        => '1',
            'show_tasks'           => '0',
            'tasks_categories'     => 'Setup,Food,Activities,Cleanup,Other',
            'tasks_show_rewards'   => '0',
            'tasks_require_login'  => '0',
            ...
            'show_damage'          => '0',
            'show_incidents'       => '1',
            'show_incidents_command' => '0',
            'show_triage'          => '0',
            'incident_type_set'    => 'camping',
            'show_games'          => '1',
            'show_wiki'           => '1',
            'show_supplies'       => '0',
            'show_seeds'          => '0',
